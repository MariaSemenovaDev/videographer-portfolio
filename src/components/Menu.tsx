...
const menuDescriptions: Record<string, string> = {
  ...
  '/projects': 'Подборка видео для событий, брендов и личных историй.',
  '/process': 'Как я готовлюсь к съёмке, работаю на площадке и собираю итоговый фильм.',
  '/news': 'Заметки о съёмке, монтаже, визуальном языке и рабочих наблюдениях.',
