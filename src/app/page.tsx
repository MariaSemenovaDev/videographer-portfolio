          ...
          <div className="w-full lg:w-[60%] relative z-20">
            ...
            <div className="w-full lg:w-[80%] border-t border-black/10 pt-12">
              ...
              <p className="text-xl md:text-2xl text-black/80 font-light leading-relaxed">
                Я глубоко убежден, что в каждом кадре должна жить история. Мой подход — это поиск естественности в постановке и кинематографичности в репортаже. Я не просто фиксирую события, я создаю визуальный ритм, который заставляет зрителя чувствовать момент, даже спустя годы.
              </p>
            </div>
          </div>

          {/* ПРАВАЯ ЧАСТЬ: ПРЯМОУГОЛЬНОЕ ФОТО (СДВИНУТО ЛЕВЕЕ) */}
          <div
