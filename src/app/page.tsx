  ...
  return (
    <div>
      <section className="relative min-h-screen overflow-hidden">
        <video loop autoPlay muted playsInline src="showreel.mp4" className="fixed inset-0 -z-999 h-full w-full object-cover" />
        <div className="mix-blend-screen bg-white p-4 pb-8 backdrop-blur-2xl md:p-8 md:pb-12">
        ...
        <div className="sticky bottom-0 top-auto flex min-h-[72vh] items-end text-white">
      ...
      <section className="min-h-screen bg-[#fffef7] px-6 py-24 md:px-10 lg:px-14">
      ...
      <section className="bg-[#f3efe8] px-6 py-24 md:px-10 lg:px-14">
