  ...
  return (
    <section className="bg-black px-6 py-24 text-white md:px-10 lg:px-14">
      <div className="mx-auto max-w-7xl">
        <p className="text-xl uppercase text-white/55">Репортажи</p>
        <h1 className="mt-6 max-w-4xl text-4xl leading-[0.96] md:text-6xl">
          Репортажная съёмка для событий, где важно сохранить не только программу, но и энергию места, людей и движения.
        </h1>
